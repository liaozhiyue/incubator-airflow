...
class TaskInstance(Base, LoggingMixin):
    ...
    def get_template_context(self, session=None):
        ...
        return {
            ...
            'END_DATE': ds,
            'end_date': ds,
            'beijing_ds': beijing_ds,
            'beijing_ds_nodash': beijing_ds_nodash,
            'beijing_ts': beijing_ts,
            'beijing_ts_nodash': beijing_ts_nodash,
            'beijing_month_start_ds': beijing_month_start_ds,
            'beijing_month_end_ds': beijing_month_end_ds,
            'beijing_week_start_ds': beijing_week_start_ds,
            'beijing_week_end_ds': beijing_week_end_ds,
            'keep_month_start_ds': keep_month_start_ds,
            'keep_month_end_ds': keep_month_end_ds,
            'dag_run': dag_run,
            'run_id': run_id,
            'execution_date': self.execution_date,
